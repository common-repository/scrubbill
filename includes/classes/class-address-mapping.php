...
class Address_Mapping {
	...
	public function hooks() {
		...
		if ( 'no' !== $override_labels ) {
			add_filter( 'woocommerce_default_address_fields', array( $this, 'set_address_fields' ), 99 );
			add_filter( 'woocommerce_checkout_fields', array( $this, 'set_placeholder_fields' ), 99 );
		}
	}
